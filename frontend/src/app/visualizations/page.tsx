    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-[#000000] via-[#080645] to-[#260c2c]">
      ...
      >
        <iframe
          width="850"
          height="500"
          src="https://lookerstudio.google.com/embed/reporting/5e0871d0-a3bf-4bc5-ab0a-a50812e001d1/page/c5HbF"
          frameBorder="0"
        ...
        <div className="mt-4 text-center text-[#b0b3b8] text-sm">
          <span>
            ...
            the <b>Looker Studio</b> text at the bottom right of the report.
          </span>
        </div>
      </div>
    </div>
